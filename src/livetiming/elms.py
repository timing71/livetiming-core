...
class Service(WEC):
    ...
    def getStaticData(self):
        Logger().info("Retrieving ELMS static data...")
        static_data_url = "http://www.europeanlemansseries.com/en/live"
    ...
    def getRawFeedData(self):
        feed_url = "http://www.europeanlemansseries.com/assets/1/live/ELMS/data.js?tx={}&t={}".format(
            "",
            int(time.time() / 15)
        )
